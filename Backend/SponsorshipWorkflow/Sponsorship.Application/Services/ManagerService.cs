...
namespace Sponsorship.Application.Services
{
    public class ManagerService : IManagerService   
    {
        ...
        {
            var requests = await _requestRepo.FindAsync(r => r.Status == RequestStatus.PendingManager);
            return requests.ToList();
        }

        public async Task<SponsorshipRequest> Approve(int requestId, int managerId, string remarks)
        {
        ...
        public async Task<SponsorshipRequest> Reject(int requestId, int managerId, string remarks)
        {
            var request = await _requestRepo.GetByIdAsync(requestId);
